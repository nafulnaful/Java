...
//   public HashMap<String, ImageDB> iDB= new HashMap<String, ImageDB>(); //이미지 저장을 위한 배열
   ...
   public SellPage(MainFrame mainF, UserHandler uh) {
      this.mainF = mainF;
      this.uh = uh;
      cardao = new CarDAO();
...
///////////////////////////////////////////////////////////////////////////////////
   ...
   public void carInsert() throws AuthenException {
      ...
      try {
    	  ...
    	  CarDB cdb=new CarDB(300,carclient.myId,no,brand,model,year,acc,km,price,img);
        System.out.println(cdb.getCarModel());
//         /** 차량번호 중복체크 */
...
//            mainF.lbBuy.setIcon(new ImageIcon("src/images/하단바_내차구매선택.png"));
         ...
         System.out.println("sellpage데이터");
         Response(cdb);
      } catch (Exception e) {
   ...
   private void Response(CarDB cdb2) {
	try {
